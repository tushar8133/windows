...
- `shutdown /r /o /t 1` reboot to advance options menu
...
- Restore Offline commands
  ...
  c:\localVSlayout\vs_buildtools.exe --wait --noWeb --all
...
# Parallels
- https://schneegans.de/windows/unattend-generator
  - "Import .xml file generated by this service"
  - "Choose File" - [autounattend.xml](autounattend.xml)
  - "Download .xml wrapped in .iso file"
  - save "unattend.iso"
